...
def execute(sql: Any, con: Any, cur: Optional[Any] = ...,
            params: Optional[Any] = ...) -> Any:
    ...


def read_sql_table(table_name: Any, con: Any, schema: Optional[Any] = ...,
...
def read_sql_query(sql: Any, con: Any, index_col: Optional[Any] = ...,
...
def read_sql(sql: Any, con: Any, index_col: Optional[Any] = ...,
             coerce_float: bool = ..., params: Optional[Any] = ...,
...
def to_sql(frame: Any, name: Any, con: Any, schema: Optional[Any] = ...,
...
def pandasSQL_builder(con: Any, schema: Optional[Any] = ...,
...
class SQLTable(PandasObject):
    ...
    def __init__(self, name: Any, pandas_sql_engine: Any,
    ...
    def read(self, coerce_float: bool = ..., parse_dates: Optional[Any] = ...,
             columns: Optional[Any] = ...,
             chunksize: Optional[Any] = ...) -> Any:
        ...
...
class SQLDatabase(PandasSQL):
    ...
    def __init__(self, engine: Any, schema: Optional[Any] = ...,
    ...
    def read_table(self, table_name: Any, index_col: Optional[Any] = ...,
                   coerce_float: bool = ..., parse_dates: Optional[Any] = ...,
                   columns: Optional[Any] = ..., schema: Optional[Any] = ...,
                   chunksize: Optional[Any] = ...) -> Any:
        ...

    def read_query(self, sql: Any, index_col: Optional[Any] = ...,
                   coerce_float: bool = ..., parse_dates: Optional[Any] = ...,
                   params: Optional[Any] = ...,
                   chunksize: Optional[Any] = ...) -> Any:
        ...
...
def get_schema(frame: Any, name: Any, keys: Optional[Any] = ...,
