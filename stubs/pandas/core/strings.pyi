...
def str_contains(arr: Any, pat: Any, case: bool = ..., flags: int = ...,
...
def str_replace(arr: Any, pat: Any, repl: Any, n: int = ...,
...
def str_match(arr: Any, pat: Any, case: bool = ..., flags: int = ...,
              na: Any = ...) -> Any:
    ...


def str_extract(arr: Any, pat: Any, flags: int = ...,
                expand: bool = ...) -> Any:
    ...
...
def str_find(arr: Any, sub: Any, start: int = ..., end: Optional[Any] = ...,
             side: str = ...) -> Any:
    ...


def str_index(arr: Any, sub: Any, start: int = ..., end: Optional[Any] = ...,
              side: str = ...) -> Any:
    ...


def str_pad(arr: Any, width: Any, side: str = ...,
            fillchar: str = ...) -> Any:
    ...


def str_split(arr: Any, pat: Optional[Any] = ...,
              n: Optional[Any] = ...) -> Any:
    ...


def str_rsplit(arr: Any, pat: Optional[Any] = ...,
               n: Optional[Any] = ...) -> Any:
    ...


def str_slice(arr: Any, start: Optional[Any] = ..., stop: Optional[Any] = ...,
              step: Optional[Any] = ...) -> Any:
    ...


def str_slice_replace(arr: Any, start: Optional[Any] = ...,
                      stop: Optional[Any] = ...,
...
class StringMethods(NoNewAttributesMixin):
    ...
    def cat(self, others: Optional[Any] = ..., sep: Optional[Any] = ...,
            na_rep: Optional[Any] = ..., join: Optional[Any] = ...) -> Any:
        ...

    def split(self, pat: Optional[Any] = ..., n: int = ...,
              expand: bool = ...) -> Any:
        ...

    def rsplit(self, pat: Optional[Any] = ..., n: int = ...,
               expand: bool = ...) -> Any:
        ...
    ...
    def contains(self, pat: Any, case: bool = ..., flags: int = ...,
                 na: Any = ..., regex: bool = ...) -> Any:
        ...

    def match(self, pat: Any, case: bool = ..., flags: int = ...,
              na: Any = ...) -> Any:
        ...

    def replace(self, pat: Any, repl: Any, n: int = ...,
                case: Optional[Any] = ..., flags: int = ...,
                regex: bool = ...) -> Any:
        ...
    ...
    def slice(self, start: Optional[Any] = ..., stop: Optional[Any] = ...,
              step: Optional[Any] = ...) -> Any:
        ...

    def slice_replace(self, start: Optional[Any] = ...,
                      stop: Optional[Any] = ...,
                      repl: Optional[Any] = ...) -> Any:
        ...
    ...
    def find(self, sub: Any, start: int = ...,
             end: Optional[Any] = ...) -> Any:
        ...

    def rfind(self, sub: Any, start: int = ...,
              end: Optional[Any] = ...) -> Any:
        ...
    ...
    def index(self, sub: Any, start: int = ...,
              end: Optional[Any] = ...) -> Any:
        ...

    def rindex(self, sub: Any, start: int = ...,
               end: Optional[Any] = ...) -> Any:
        ...
