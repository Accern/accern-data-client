...
class PeriodIndex(DatetimeIndexOpsMixin):
    ...
    def __new__(cls, data=..., ordinal=..., freq=..., dtype: Dtype | None = ..., copy: bool = ..., name: Hashable = ..., **fields) -> PeriodIndex:
        ...
    ...
    @doc(Index.astype)
    def astype(self, dtype, copy: bool = ..., how=...): # -> DatetimeIndex | PeriodIndex | Index:
        ...
...
def period_range(start=..., end=..., periods: int | None = ..., freq=..., name=...) -> PeriodIndex:
    """
