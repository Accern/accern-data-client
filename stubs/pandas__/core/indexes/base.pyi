...
class Index(IndexOpsMixin, PandasObject):
    ...
    def set_names(self, names, level=..., inplace: bool = ...): # -> ABCMultiIndex | Self@Index | None:
        """
    ...
    def sortlevel(self, level=..., ascending=..., sort_remaining=...): # -> tuple[Self@Index | MultiIndex, Unknown | Any] | Self@Index | MultiIndex:
        """
    ...
    def __reduce__(self): # -> tuple[(cls: Unknown, d: Unknown) -> (ABCPeriodIndex | ABCMultiIndex | Unknown), tuple[Type[Self@Index], dict[str, Unknown]], None]:
        ...
    ...
    @final
    def __and__(self, other): # -> ABCMultiIndex | Self@Index | Any | Index | None:
        ...
    
    @final
    def __or__(self, other): # -> ABCMultiIndex | Self@Index | Index | None:
        ...
    
    @final
    def __xor__(self, other): # -> ABCMultiIndex | Self@Index | Index | None:
        ...
    ...
    @final
    def intersection(self, other, sort=...): # -> ABCMultiIndex | Self@Index | Any | Index | None:
        """
    ...
    @final
    def difference(self, other, sort=...): # -> Any | ABCMultiIndex | Index | Self@Index | None:
        """
    ...
    def symmetric_difference(self, other, result_name=..., sort=...): # -> ABCMultiIndex | Self@Index | Index | None:
        """
    ...
    def join(self, other, how: str_t = ..., level=..., return_indexers: bool = ..., sort: bool = ...): # -> tuple[MultiIndex, Unknown, Unknown] | tuple[MultiIndex, Unknown | None, Unknown | None] | tuple[ABCDatetimeIndex | Self@Index, None, ndarray] | tuple[ABCDatetimeIndex | Index, ndarray, None] | tuple[Unknown, Unknown, Unknown] | tuple[Index, Unknown, Unknown] | tuple[Index, Unknown | None, Unknown | None]:
        """
    ...
    def __getitem__(self, key): # -> Any | Self@Index | ExtensionArray:
        """
    ...
    @final
    def asof(self, label): # -> NaTType | float | object | Any | Index | ExtensionArray:
        """
    ...
    def sort_values(self, return_indexer: bool = ..., ascending: bool = ..., na_position: str_t = ..., key: Callable | None = ...): # -> tuple[Self@Index | MultiIndex, Unknown | Any] | Self@Index | MultiIndex:
        """
