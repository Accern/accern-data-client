...
class MultiIndex(Index):
    ...
    def __reduce__(self): # -> tuple[(cls: Unknown, d: Unknown) -> (ABCPeriodIndex | ABCMultiIndex | Unknown), tuple[Type[Self@MultiIndex], dict[str, Unknown]], None]:
    ...
    def get_loc_level(self, key, level=..., drop_level: bool = ...): # -> tuple[Unknown, Unknown]:
        """
