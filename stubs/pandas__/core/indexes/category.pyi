...
@inherit_names(["argsort", "tolist", "codes", "categories", "ordered", "_reverse_indexer", "searchsorted", "is_dtype_equal", "min", "max"], Categorical)
...
class CategoricalIndex(NDArrayBackedExtensionIndex):
    ...
    _data: Categorical
    _values: Categorical
    def __new__(cls, data=..., categories=..., ordered=..., dtype: Dtype | None = ..., copy: bool = ..., name: Hashable = ...) -> CategoricalIndex:
        ...
