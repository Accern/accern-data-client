...
class _Unstacker:
    ...
    @cache_readonly
    def sorted_labels(self): # -> list[generic]:
        ...
    ...
    def get_new_values(self, values, fill_value=...): # -> tuple[ndarray, ndarray] | tuple[DatetimeArray | Unknown | ndarray, ndarray]:
        ...
...
def unstack(obj, level, fill_value=...): # -> Series | DataFrame:
    ...
