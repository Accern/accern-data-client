...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    def __getstate__(self): # -> tuple[list[Index], list[ndarray | ExtensionArray], list[Any | Index | Unknown | ExtensionArray], dict[str, dict[str, Unknown]]]:
        ...
