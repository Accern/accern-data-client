...
class PeriodArray(dtl.DatelikeOps):
    ...
    def astype(self, dtype, copy: bool = ...): # -> Self@PeriodArray | PeriodArray | DatetimeArray | ndarray | ExtensionArray:
        ...
...
def dt64arr_to_periodarr(data, freq, tz=...): # -> tuple[Unknown, Unknown]:
    """
