...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    def __iter__(self): # -> Generator[DTScalarOrNaT | Unknown, None, None]:
        """
    ...
    def astype(self, dtype, copy: bool = ...): # -> Self@DatetimeArray | DatetimeArray | ndarray | PeriodArray | ExtensionArray:
        ...
...
def objects_to_datetime64ns(data: np.ndarray, dayfirst, yearfirst, utc=..., errors=..., require_iso8601: bool = ..., allow_object: bool = ..., allow_mixed: bool = ...): # -> tuple[ndarray, tzinfo | None] | tuple[ndarray, tzinfo] | tuple[ndarray, None]:
    """
...
def maybe_convert_dtype(data, copy: bool): # -> tuple[Unknown, bool] | tuple[Unknown | ndarray, bool]:
    """
