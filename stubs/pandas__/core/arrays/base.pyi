...
import numpy as np
from typing import Any, Iterator, Literal, Sequence, TYPE_CHECKING, TypeVar, overload
from pandas._typing import ArrayLike, AstypeArg, Dtype, FillnaOptions, NumpySorter, NumpyValueArrayLike, PositionalIndexer, ScalarIndexer, SequenceIndexer, Shape, TakeIndexer, npt
...
class ExtensionArray:
    ...
    * _from_sequence_of_strings
    ...
    def fillna(self, value: object | ArrayLike | None = ..., method: FillnaOptions | None = ..., limit: int | None = ...): # -> Self@ExtensionArray:
        """
    ...
    def repeat(self, repeats: int | Sequence[int], axis: int | None = ...): # -> Self@ExtensionArray:
        ...
    
    def take(self: ExtensionArrayT, indices: TakeIndexer, *, allow_fill: bool = ..., fill_value: Any = ...) -> ExtensionArrayT:
        """
    ...
    def __array_ufunc__(self, ufunc: np.ufunc, method: str, *inputs, **kwargs): # -> _NotImplementedType | tuple[Unknown, ...] | Any:
        ...
