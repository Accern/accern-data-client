...
class WrappedCythonOp:
    ...
    _cython_arity = ...
    def get_cython_func_and_vals(self, values: np.ndarray, is_numeric: bool): # -> tuple[Any, ndarray] | tuple[Any | None, ndarray]:
        """
...
class BinGrouper(BaseGrouper):
    ...
    @cache_readonly
    def groups(self): # -> dict[Any, Unknown]:
        """dict {group name -> group labels}"""
        ...
    ...
    @cache_readonly
    def result_index(self): # -> Any | Index | ExtensionArray:
        ...
