...
def maybe_promote(dtype: np.dtype, fill_value=...): # -> tuple[dtype[Unknown], float] | tuple[dtype[Unknown], object | generic | float | Literal[0, False]] | tuple[dtype[Unknown], Any] | tuple[dtype[Unknown], datetime64] | tuple[dtype[Unknown], datetime64 | (() -> datetime64)] | tuple[dtype[Any], <subclass of float and date> | <subclass of float and str> | <subclass of <subclass of <subclass of float and date> and datetime> and str> | float | <subclass of <subclass of float and date> and datetime>] | tuple[dtype[Any], float] | tuple[dtype[object_] | dtype[float64] | dtype[Unknown], float | generic]:
    """
...
def maybe_infer_dtype_type(element): # -> _DType | None:
    """
...
def find_common_type(types): # -> DtypeObj | dtype[Any]:
    """
