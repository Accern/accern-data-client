...
_dtype_object = ...
_dtype_str = ...
def isna(obj): # -> bool | ndarray | ExtensionArraySupportsAnyAll | Any | Series | DataFrame:
    """
...
isnull = ...
def notna(obj): # -> bool | int | Any | Series | DataFrame:
    """
...
def na_value_for_dtype(dtype: DtypeObj, compat: bool = ...): # -> object | generic | float | Literal[0, False]:
    """
