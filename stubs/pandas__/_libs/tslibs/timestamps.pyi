...
from pandas._libs.tslibs import BaseOffset, NaTType, Period, Timedelta
...
class Timestamp(datetime):
    ...
    value: int
    def __new__(cls: type[_DatetimeT], ts_input: int | np.integer | float | str | _date | datetime | np.datetime64 = ..., freq: int | None | str | BaseOffset = ..., tz: str | _tzinfo | None | int = ..., unit: str | int | None = ..., year: int | None = ..., month: int | None = ..., day: int | None = ..., hour: int | None = ..., minute: int | None = ..., second: int | None = ..., microsecond: int | None = ..., nanosecond: int | None = ..., tzinfo: _tzinfo | None = ..., *, fold: int | None = ...) -> _DatetimeT | NaTType:
        ...
    ...
    @classmethod
    def fromordinal(cls: type[_DatetimeT], ordinal: int, freq: str | BaseOffset | None = ..., tz: _tzinfo | str | None = ...) -> _DatetimeT:
        ...
    ...
    def replace(self, year: int = ..., month: int = ..., day: int = ..., hour: int = ..., minute: int = ..., second: int = ..., microsecond: int = ..., tzinfo: _tzinfo | None = ..., fold: int = ...) -> datetime:
        ...
    ...
    def tz_localize(self: _DatetimeT, tz: _tzinfo | str | None, ambiguous: str = ..., nonexistent: str = ...) -> _DatetimeT:
        ...
