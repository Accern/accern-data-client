...
class NaTType(datetime):
    ...
    def __lt__(self, other: datetime | timedelta | Period | np.datetime64 | np.timedelta64) -> bool:
        ...
    
    def __le__(self, other: datetime | timedelta | Period | np.datetime64 | np.timedelta64) -> bool:
        ...
    
    def __gt__(self, other: datetime | timedelta | Period | np.datetime64 | np.timedelta64) -> bool:
        ...
    
    def __ge__(self, other: datetime | timedelta | Period | np.datetime64 | np.timedelta64) -> bool:
        ...
