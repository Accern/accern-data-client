...
from pandas._typing import Frequency, Timezone, npt
...
class Period:
    ordinal: int
    freq: BaseOffset
    def __new__(cls, value=..., freq: int | str | None = ..., ordinal: int | None = ..., year: int | None = ..., month: int | None = ..., quarter: int | None = ..., day: int | None = ..., hour: int | None = ..., minute: int | None = ..., second: int | None = ...) -> Period | NaTType:
        ...
    ...
    def to_timestamp(self, freq: str | BaseOffset | None = ..., how: str = ..., tz: Timezone | None = ...) -> Timestamp:
        ...
