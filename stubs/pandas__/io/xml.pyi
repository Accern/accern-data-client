...
from pandas._typing import CompressionOptions, FilePath, ReadBuffer, StorageOptions, XMLParsers
...
class _XMLFrameParser:
    ...
    functionality.
    """
    def __init__(self, path_or_buffer: FilePath | ReadBuffer[bytes] | ReadBuffer[str], xpath: str, namespaces: dict[str, str] | None, elems_only: bool, attrs_only: bool, names: Sequence[str] | None, encoding: str | None, stylesheet: FilePath | ReadBuffer[bytes] | ReadBuffer[str] | None, compression: CompressionOptions, storage_options: StorageOptions) -> None:
        ...
...
@deprecate_nonkeyword_arguments(version=None, allowed_args=["path_or_buffer"], stacklevel=2)
@doc(storage_options=_shared_docs["storage_options"], decompression_options=_shared_docs["decompression_options"] % "path_or_buffer")
def read_xml(path_or_buffer: FilePath | ReadBuffer[bytes] | ReadBuffer[str], xpath: str = ..., namespaces: dict[str, str] | None = ..., elems_only: bool = ..., attrs_only: bool = ..., names: Sequence[str] | None = ..., encoding: str | None = ..., parser: XMLParsers = ..., stylesheet: FilePath | ReadBuffer[bytes] | ReadBuffer[str] | None = ..., compression: CompressionOptions = ..., storage_options: StorageOptions = ...) -> DataFrame:
    r"""
