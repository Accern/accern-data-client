...
class RowStringConverter(ABC):
    ...
    """
    def __init__(self, formatter: DataFrameFormatter, multicolumn: bool = ..., multicolumn_format: str | None = ..., multirow: bool = ...) -> None:
        ...
...
class TableBuilderAbstract(ABC):
    ...
    """
    def __init__(self, formatter: DataFrameFormatter, column_format: str | None = ..., multicolumn: bool = ..., multicolumn_format: str | None = ..., multirow: bool = ..., caption: str | None = ..., short_caption: str | None = ..., label: str | None = ..., position: str | None = ...) -> None:
        ...
...
class LatexFormatter:
    ...
    HTMLFormatter
    """
    def __init__(self, formatter: DataFrameFormatter, longtable: bool = ..., column_format: str | None = ..., multicolumn: bool = ..., multicolumn_format: str | None = ..., multirow: bool = ..., caption: str | tuple[str, str] | None = ..., label: str | None = ..., position: str | None = ...) -> None:
        ...
