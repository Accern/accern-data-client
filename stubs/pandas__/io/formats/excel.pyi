...
class CSSToExcelConverter:
    ...
    def build_fill(self, props: Mapping[str, str]): # -> dict[str, Unknown] | None:
        ...
    
    def build_number_format(self, props: Mapping[str, str]) -> dict[str, str | None]:
        ...
    
    def build_font(self, props: Mapping[str, str]) -> dict[str, bool | int | float | str | None]:
        ...
...
class ExcelFormatter:
    ...
    @property
    def header_style(self): # -> dict[str, Unknown]:
        ...
    ...
    def write(self, writer, sheet_name=..., startrow=..., startcol=..., freeze_panes=..., engine=..., storage_options: StorageOptions = ...): # -> None:
        """
