...
if TYPE_CHECKING:
    ...
def hist_series(self, by=..., ax=..., grid: bool = ..., xlabelsize: int | None = ..., xrot: float | None = ..., ylabelsize: int | None = ..., yrot: float | None = ..., figsize: tuple[int, int] | None = ..., bins: int | Sequence[int] = ..., backend: str | None = ..., legend: bool = ..., **kwargs): # -> Any:
    """
...
def hist_frame(data: DataFrame, column: IndexLabel = ..., by=..., grid: bool = ..., xlabelsize: int | None = ..., xrot: float | None = ..., ylabelsize: int | None = ..., yrot: float | None = ..., ax=..., sharex: bool = ..., sharey: bool = ..., figsize: tuple[int, int] | None = ..., layout: tuple[int, int] | None = ..., bins: int | Sequence[int] = ..., backend: str | None = ..., legend: bool = ..., **kwargs): # -> Any:
    """
...
def boxplot(data, column=..., by=..., ax=..., fontsize=..., rot=..., grid=..., figsize=..., layout=..., return_type=..., **kwargs): # -> Any:
    ...

@Substitution(backend=_backend_doc)
@Appender(_boxplot_doc)
def boxplot_frame(self, column=..., by=..., ax=..., fontsize=..., rot=..., grid=..., figsize=..., layout=..., return_type=..., backend=..., **kwargs): # -> Any:
    ...

def boxplot_frame_groupby(grouped, subplots=..., column=..., fontsize=..., rot=..., grid=..., ax=..., figsize=..., layout=..., sharex=..., sharey=..., backend=..., **kwargs): # -> Any:
    """
